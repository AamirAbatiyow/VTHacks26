...
const steps = [
  { title: "Make this space yours.", text: "Choose Conversation for everyday talk, Speech Exercises for a technique chosen for you, or Endless for a living round with no clock. Conversation needs a time first — 2, 5, 10, or 15 minutes.", note: "Endless rests the talk on a kind beat. Richer sentences score higher than long, simple ones.", icon: "spark" as const },
